...
export default function Navbar() {
  ...
  return (
    <div className="min-h-[70px] transform-gpu sticky top-0 py-1 px-4 hidden sm:flex gap-x-10 justify-between items-center bg-black bg-opacity-80 backdrop-blur-md text-white z-20">
      <button
        ref={ref}
