...
export default function Order({ order }: Props) {
  ...
  return (
    <div
      className={clsx({
        "p-3 rounded-lg border transition-all duration-300 sm:hover:border-slate-400 border-black sm:border-slate-400": true,
      })}
    >
      ...
      <div className={clsx({
        "grid transition-all duration-300 grid-rows-[1fr]": true,
      })}>
        <div className={clsx({
          "flex flex-col gap-5 transition-all duration-300 overflow-hidden mt-3": true,
        })}
        >
